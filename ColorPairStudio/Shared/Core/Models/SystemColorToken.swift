...
enum SystemColorToken: String, CaseIterable, Codable, Sendable {
...
private enum _SystemColorTokenLookup {
    /// sRGB approximations for system colors (sufficient for ΔE/contrast math in Approximator previews)
    static func rgba(for token: SystemColorToken) -> RGBA {
        switch token {
        case .red:     return RGBA(r: 1.00, g: 0.23, b: 0.19, a: 1.0)   // 255,59,48
        case .orange:  return RGBA(r: 1.00, g: 0.59, b: 0.00, a: 1.0)   // 255,149,0
        case .yellow:  return RGBA(r: 1.00, g: 0.84, b: 0.04, a: 1.0)   // 255,214,10
